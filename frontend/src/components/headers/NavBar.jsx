...
const NavBar = () => {
    ...
    return (
        ...
        >
            <div className="lg:w-[95%] mx-auto sm:px-6 lg:px-2">
                <div className="flex px-0 items-center justify-between py-4">
                    {/* Logo */}
                    <div onClick={() => navigate('/')} className="flex-shrink-0 cursor-pointer pl-0 md:p-0 flex items-center">
                        <div className={``}>
                            <h1 className='text-2xl font-Cinzel  inline-flex gap-3  items-center font-bold'>BalBuddhiVidya<img src="/yoga-logo.png" alt="" className='w-10 h-10' /></h1>
                            <p className='font-bold text-[13px]  tracking-[4px]'>Ancient wisdom for modern minds</p>
                        </div>
                    </div>
