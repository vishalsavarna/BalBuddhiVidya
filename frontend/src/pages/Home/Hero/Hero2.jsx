            ...
            <div className="min-h-screen flex justify-start pl-11 text-white items-center bg-black bg-opacity-60">
                <div className="">
                    <div className="space-y-4">
                        <h3 className='md:text-4xl text-2xl'>Elevate Your</h3>
                        <h1 className='md:text-7xl text-4xl font-bold '>Fitness Journey</h1>
                        <div className="md:w-1/2">
                            <p className=''>Join our online gym classes and train with top instructors. From strength training to cardio, achieve your fitness goals with personalized workouts. Push your limits and get stronger—join today!</p>
                        </div>
